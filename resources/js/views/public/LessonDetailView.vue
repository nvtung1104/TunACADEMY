<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div v-else-if="!lesson" class="py-20 text-center">
      ...
      <RouterLink to="/lessons" class="mt-4 inline-block text-sm text-[#d63015] hover:underline">← Quay lại danh sách</RouterLink>
    </div>

    <template v-else>
      <div class="animate__animated animate__fadeIn">
        <!-- Back -->
        <RouterLink to="/lessons" class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-[#d63015] mb-6 transition-colors">
        ...
        <div class="grid lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2 space-y-5">
            ...
            <div v-if="lesson.content" class="bg-white rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div class="p-6 prose prose-sm max-w-none text-gray-700 leading-relaxed" v-html="renderMath(lesson.content)" />
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-3">
              ...
              <template v-if="auth.isStudent">
                <RouterLink :to="`/student/lessons/${route.params.id}/learn`"
                  class="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl text-sm font-semibold bg-[#d63015] hover:bg-[#c02a10] text-white transition-colors">
                  <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div v-if="lesson.subject" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
              ...
              <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center"
                  :style="{ backgroundColor: (lesson.subject.color || '#d63015') + '18' }">

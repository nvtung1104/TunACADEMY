...
class ClassroomController extends Controller
{
    ...
    public function show(Request $request, Classroom $classroom)
    {
        ...
        return $this->success(new ClassroomResource($classroom->load(['grade', 'schoolYear', 'homeroomTeacher', 'subjectTeachers.teacher', 'subjectTeachers.subject', 'students'])->loadCount(['lessons', 'assignments', 'exams'])));
    }
